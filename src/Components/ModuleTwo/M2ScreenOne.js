    ...
    <div>
      <div className="h-full w-auto border-t-4 shadow-lg border-[#E5D610] bg-[#FBF9E8] p-8 m-20 rounded-xl">
        ...
        <div className="flex ">
          ...
          <div className=" flex-1 place-items-center bg-[#9D282820] mr-5 p-3 border-dashed border-2">
            <label for="file">
              <div className="flex">
                <div>
                  <BsFileEarmarkArrowDown />
        ...
        <div className="grid justify-center py-5">
          <p className="text-[#E12208] text-xs">
            *Alert: There is some daviation in required Criteria in Uploaded
            Details. Please Assign The Ticket To Module 1 For Redo The Ticket.
          </p>
          <div className="py-4 grid grid-cols-2 ">
            <div
              className="border-2 border-solid border-black flex justify-center p-2 rounded-lg col-span-1 m-1"
              onClick={() => navigate("/M2ScreenTwo")}
            >
              <button className="text-black-500 text-xs font-semibold text-center">
                Assign To Module 1 For Redo Ticket
              </button>
            </div>
            <div className="border-2 border-solid bg-[#41414120] p-2 flex justify-center rounded-lg col-span-1 m-1">
