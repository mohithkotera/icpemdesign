  ...
  return (
    <div>
      <div className="h-full w-auto border-t-4 shadow-lg border-[#E5D610] bg-[#FBF9E8] p-8 m-20 rounded-xl">
        ...
        <div
          className="py-4 grid grid-cols-2 gap-2 "
          onClick={() => navigate("/M4Certificate")}
        >
          <div className="justify-end grid">
            <div className="border-2 border-solid  flex justify-center border-black p-2 rounded-lg w-72 col-span-1 m-1">
          ...
          <div className="justify-start grid">
            <div className=" bg-[#E5D610] p-2  flex justify-center rounded-lg col-span-1 m-1  w-72">
              <button className="text-black-500 text-xs font-semibold text-center">
                Preview The Mark Sheet
              </button>
            </div>
          </div>
        </div>
