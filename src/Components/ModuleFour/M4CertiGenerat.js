      ...
      <div className="h-full w-auto  bg-[#fdf8e1] p-8 m-20 rounded-xl">
        ...
        <div className=" grid grid-cols-2 py-8 ">
          <div className=" grid justify-end col-span-1">
            <div
              className="border-2 border-solid border-black p-2  flex justify-center rounded-lg w-64 m-1"
              onClick={() => navigate("/M5GenerateMarks")}
            >
...
export default M4GenerateCerti;
